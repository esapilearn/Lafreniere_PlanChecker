...
namespace ESAPX_StarterUI.ViewModels
{
    public class CTDateConstraint : IConstraint
    {
        ...
        public ConstraintResult CanConstrain(PlanningItem pi)
        {
            ...
            //if (image != null) { return new ConstraintResult(this, ResultType.PASSED, "");}
            var pq = new PQAsserter(pi);
            return pq.HasImage()//can add more stuff here
                .CumulativeResult;
        }
        ...
        {
            //var plan = new PlanSetup;//can't do this! Varian prevents it!
        ...
        {
            //Check if the CT is less than 60 days old, otherwise FAILS
